...
namespace elZach.LevelEditor
{
    ...
    public class TileAtlas : ScriptableObject
    {
        ...
        [System.Serializable]
        public class GuidTileObjectDictionary : SerializableDictionary<string, TileObject> { }

        //[Reorderable]
        public List<TileObject> tiles;
        [HideInInspector]
        public GuidTileObjectDictionary TileFromGuid = new GuidTileObjectDictionary();
        [HideInInspector]
